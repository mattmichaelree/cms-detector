...
| **Floor debate transcripts** | Journals record actions, not words; the argument that killed a bill on the floor is only in the video | House/Senate video archives + ASR pipeline. Head start verified in this audit: House HLS streams embed harvestable WebVTT auto-captions (rollout since ~Feb 2026, ~8% of 89R committee videos and growing) — harvest those free, ASR the rest, prioritized by relevance |
| **Committee hearing transcripts** | Same — witness lists say who; only audio says what (no official transcripts exist, confirmed) | Same caption-harvest + ASR pipeline; cache Senate media on ingest — the Senate states its stream is the only copy |
